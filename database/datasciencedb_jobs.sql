...
CREATE TABLE `jobs` (
  ...
  CONSTRAINT `jobs_ibfk_1` FOREIGN KEY (`CompanyID`) REFERENCES `companies` (`CompanyID`),
  CONSTRAINT `jobs_ibfk_2` FOREIGN KEY (`JobTypeID`) REFERENCES `jobtypes` (`JobTypeID`)
...
-- Dump completed on 2026-07-22 15:23:19
